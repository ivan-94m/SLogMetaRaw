...
3. **Tonos**: `Shadows`, `Highlights` y `Contrast` actúan sobre la luminancia en log2 alrededor del gris 18%, con los
   pesos de sombras y altas luces desvaneciéndose a lo largo de cinco pasos, de modo que se quedan donde deben en vez de
   inclinar toda la imagen.
